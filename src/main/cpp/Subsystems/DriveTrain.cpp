...
AddChild("shifterReal", shifter);
leftFollowMotor.Follow(leftLeaderMotor);
rightFollowMotor.Follow(rightLeaderMotor);
...
void DriveTrain::SetLeftPower(double power) {
    leftLeaderMotor.Set(power);
}
void DriveTrain::SetRightPower(double power) {
    rightLeaderMotor.Set(-power);
}
