...
/*double spinUpP = 0.000048;
double spinUpI = 0.0000004;
double spinUpD = 0.0;
double spinUpF = 0.00008;*/

double maintainP = 0.0001;
double maintainI = 0.00000001;
double maintainD = 0.0;
...
AddChild("ShooterPositionServo", shooterPositionServo);
    ...
    shooterPidController.SetP(spinUpP, 0); //0.00017
    shooterPidController.SetI(spinUpI, 0);
    shooterPidController.SetD(spinUpD, 0);
    shooterPidController.SetFF(spinUpF, 0);

    shooterPidController.SetP(maintainP, 1);
    shooterPidController.SetI(maintainI, 1);
    shooterPidController.SetD(maintainD, 1);
    shooterPidController.SetFF(maintainF, 1);
...
void Shooter::Periodic() {
    ...
    frc::SmartDashboard::PutNumber("Shooter Actual RPM 2", shooterEncoder.GetVelocity());
...
double Shooter::CalcRPMFarShot(double currentLimeVertical) {
    //return 4.2858 * currentLimeVertical * currentLimeVertical + 4.206434 * currentLimeVertical + 4030.6577; //3429 was 3429.6577 at waterloo day 1 was 3494.6577 at end of waterloo day 2 3470.6577 before dcmp
    //return (14.345889 * currentLimeVertical*currentLimeVertical)+(153.44748*currentLimeVertical)+3910.3134;
    //return 5100;
    return (4.355 * currentLimeVertical * currentLimeVertical) - (66.8 * currentLimeVertical) + 3813.88;
}
double Shooter::CalcRPMMediumShot(double currentLimeVertical) {
    //return (3.6255652 * currentLimeVertical * currentLimeVertical) - (73.6459502 * currentLimeVertical) + 3285.363916;
    //return 2.36858 * currentLimeVertical * currentLimeVertical + -48.24201 * currentLimeVertical + 3749.9; //3439.9 was 3439.9 at waterloo day 1 was 3472.9 at end of waterloo day 2 //3516.9 before dcmp
    return (0.2754 * currentLimeVertical * currentLimeVertical) - (61.627 * currentLimeVertical) + 4252.55;
}
