...
double Shooter::CalcRPMFarShot(double currentLimeVertical) {
    ...
    //return 5100;
    return (4.355 * currentLimeVertical * currentLimeVertical) - (66.8 * currentLimeVertical) + 3713.88;
}
double Shooter::CalcRPMMediumShot(double currentLimeVertical) {
    ...
    return (0.2754 * currentLimeVertical * currentLimeVertical) - (61.627 * currentLimeVertical) + 4152.55;
}
