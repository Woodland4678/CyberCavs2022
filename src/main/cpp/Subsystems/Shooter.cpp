...
double Shooter::CalcRPMFarShot(double currentLimeVertical) {
    return 4.2858 * currentLimeVertical * currentLimeVertical + 4.206434 * currentLimeVertical + 3470.6577; //3429 was 3429.6577 at waterloo day 1 was 3494.6577 at end of waterloo day 2
    //return 5100;
}
double Shooter::CalcRPMMediumShot(double currentLimeVertical) {
    return 2.36858 * currentLimeVertical * currentLimeVertical + -48.24201 * currentLimeVertical + 3516.9; //3439.9 was 3439.9 at waterloo day 1 was 3472.9 at end of waterloo day 2
}
